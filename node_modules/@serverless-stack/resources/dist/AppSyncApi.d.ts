...
export declare class AppSyncApi extends cdk.Construct implements ISstConstruct {
    ...
    get url(): string;
    addDataSources(scope: cdk.Construct, dataSources: {
        [key: string]: FunctionDefinition | AppSyncApiLambdaDataSourceProps | AppSyncApiDynamoDbDataSourceProps | AppSyncApiRdsDataSourceProps | AppSyncApiHttpDataSourceProps;
    }): void;
    addResolvers(scope: cdk.Construct, resolvers: {
