...
export declare class Topic extends cdk.Construct implements ISstConstruct {
    ...
    addSubscribers(scope: cdk.Construct, subscribers: (FunctionDefinition | TopicFunctionSubscriberProps | Queue | TopicQueueSubscriberProps)[]): void;
